...
const executableName = 'blue_bird';
const packageName = 'blue_bird_cli';
const description = 'Blue Bird CLI.';
...
/// ```
/// {@endtemplate}
class BlueBirdCliCommandRunner extends CommandRunner<int> {
  /// {@macro blue_bird_cli_command_runner}
  BlueBirdCliCommandRunner({
    Logger? logger,
